...
def main():
    ...
    for key in error.keys():
        print(key + " perceptron:\t" + str(error[key]))
    return

if __name__ == "__main__":
    #np.set_printoptions(edgeitems=30, linewidth = 1000000) # this is just formatting for numpy print, https://www.reddit.com/r/vscode/comments/s2xjgz/how_do_i_increase_the_width_of_the_output_of_the/?ref=share&ref_source=link
    main()